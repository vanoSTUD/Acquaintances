...
namespace Acquaintances.Bot.DAL.Migrations
{
    ...
    [Migration("20250102193654_AddUniqueChatId")]
    partial class AddUniqueChatId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Acquaintances.Bot.Domain.Entities.Like", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Message", "Acquaintances.Bot.Domain.Entities.Like.Message#Message", b1 =>
                        {
                            b1.IsRequired();
